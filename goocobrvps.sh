...
echo -e "${White}     | ${Red}[${Yellow}07${Red}]${White} |$Green Install Pale Moon Browser${White}                                   |"
echo -e "${White}     | ${Red}[${Yellow}08${Red}]${White} |$Green Install Microsoft Edge${White}                                     |"
echo -e "${Yellow}     +${White}-------------------------------------------------------------------${Yellow}+"
echo ""
...
case $choice in
    ...
    6)
        ...
        ;;
    7)
        echo "Installing Pale Moon Browser..."
        docker run -d \
            --name=palemoon \
            --security-opt seccomp=unconfined \
            -e PUID=1000 \
            ...
            --shm-size="7gb" \
            --restart unless-stopped \
            ghcr.io/linuxserver/palemoon:latest
        ;;
    8)
        ...
        ;;
    *)
        echo "Invalid choice. Please enter a valid ID."
        exit 1
        ;;
esac
